...
For faster CI, `lean-action` provides a reusable workflow that runs test, lint, leanchecker, nanoda, and reservoir checks in parallel on separate runners:
...
- Then runs **test**, **lint**, **leanchecker**, **nanoda**, and **reservoir** jobs in parallel
